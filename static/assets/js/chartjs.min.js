        ...
        _update(t=Date.now()) {
            ...
            e._charts.forEach(((n,o)=>{
                ...
                for (; r >= 0; --r)
                    ...
                    a.tick(t),
                    l = !0) : (s[r] = s[s.length - 1],
                    s.pop());
                l && (o.draw(),
                e._notify(o, n, t, "progress")),
                s.length || (n.running = !1,
 ...
 */
    ...
    function k(t) {
        ...
        return o !== s && (c = o - s,
        l = a > .5 ? c / (2 - o - s) : c / (o + s),
        r = o === e ? (i - n) / c + (i < n ? 6 : 0) : o === i ? (n - e) / c + 2 : (e - i) / c + 4,
        r = 60 * r + .5),
        [0 | r, l || 0, a]
    }
    function S(t, e, i, n) {
    ...
    class z {
        constructor(t) {
            ...
            let i;
            var n, o, s;
            "object" === e ? i = I(t) : "string" === e && (s = (n = t).length,
            "#" === n[0] && (4 === s || 5 === s ? o = {
                r: 255 & 17 * r[n[1]],
                g: 255 & 17 * r[n[2]],
                b: 255 & 17 * r[n[3]],
        ...
        mix(t, e) {
            ...
            if (t) {
                ...
                s = 1 - c,
                n.r = 255 & c * n.r + s * o.r + .5,
                n.g = 255 & c * n.g + s * o.g + .5,
                n.b = 255 & c * n.b + s * o.b + .5,
                n.a = a * n.a + (1 - a) * o.a,
                i.rgb = n
            }
            return i
    ...
    function $t(t, e, i, n, o) {
        let s = e[o];
        return s || (s = e[o] = t.measureText(o).width,
        i.push(o)),
        s > n && (n = s),
        n
    }
    ...
    function qt(t, e, i, n) {
        ...
        const c = e.pointStyle
          ...
          , d = e.radius;
        let u = (h || 0) * vt;
        if (c && "object" == typeof c && (o = c.toString(),
    ...
    function Qt(t, e, i, n, o) {
        ...
        if ("middle" === o) {
            ...
            "after" === o != !!n ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y);
        t.lineTo(i.x, i.y)
    }
    function Jt(t, e, i, n) {
        if (!e)
    ...
    function te(t, e, i, n, o, s={}) {
        ...
        l = 0; l < a.length; ++l) {
            if (c = a[l],
            r && (s.strokeColor && (t.strokeStyle = s.strokeColor),
    ...
    function pe(t, e) {
        const {canvas: i, currentDevicePixelRatio: n} = e
          ...
          , {x: l, y: c, box: h} = function(t, e) {
            ...
            let r, l, c = !1;
            if (((t,e,i)=>(t > 0 || e > 0) && (!i || !i.shadowRoot))(s, a, i.target))
                r = s,
                l = a;
            else {
    ...
    function be(t, e, i) {
        ...
        o.style && (i || !o.style.height && !o.style.width) && (o.style.height = a + "px",
        o.style.width = s + "px")
    }
    const _e = function() {
        let t = !1;
    ...
    function ke(t, e, i, n) {
        const o = [];
        if (!Kt(e, t.chartArea, t._minPadding))
            return o;
    ...
    function Ue(t, e, i) {
        ...
        s = t.length; o < s; ++o)
            a = t[o],
            r = a.box,
            a.horizontal ? (r.left = r.fullSize ? n.left : e.left,
    ...
    var Xe = {
        ...
        update(t, e, i, n) {
            ...
            !function(t, e) {
                ...
                n = t.length; i < n; ++i)
                    o = t[i],
                    o.horizontal ? (o.width = o.box.fullSize && e.availableWidth,
                    o.height = e.hBoxMaxHeight) : (o.width = e.vBoxMaxWidth,
    ...
    function si(t, i, n) {
        ...
        return r.observe(s),
        function(t, e) {
            ii.size || window.addEventListener("resize", oi),
            ii.set(t, e)
        }(t, a),
        r
    }
    function ai(t, e, i) {
        ...
        "resize" === e && function(t) {
            ii.delete(t),
            ii.size || window.removeEventListener("resize", oi)
        }(t)
    }
    function ri(t, i, n) {
        const o = t.canvas
    ...
    class mi {
        ...
        tick(t) {
            const e = this
              ...
              , r = e._to;
            let l;
            if (e._active = s !== r && (a || i < n),
            !e._active)
                return e._target[o] = r,
                void e._notify(!0);
            i < 0 ? e._target[o] = s : (l = i / n % 2,
            l = a && l > 1 ? 2 - l : l,
    ...
    class bi {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new mi(d,t,l,c),
                n.push(h)) : t[l] = c
            }
            return n
        }
    ...
    function ki(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
            const i = e[t]
              , {[l]: n, [c]: s} = i;
            u = (i._stacks || (i._stacks = {}))[c] = wi(o, h, n),
            u[r] = s
        }
    }
    function Si(t, e) {
    ...
    class Ai {
        ...
        _dataCheck() {
            ...
            U(i) ? t._data = function(t) {
                ...
                return i
            }(i) : t._data !== i && (t._data && (re(t._data, t),
            Pi(t._cachedMeta)),
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            s = vi(n, o, this._cachedMeta.index, {
                all: !0
            })),
            t.min = Math.min(t.min, s),
            t.max = Math.max(t.max, s)
        ...
        getMinMax(t, e) {
            ...
            for (u = 0; u < a && (m() || (i.updateRangeFromParsed(c, t, g, l),
            !s)); ++u)
                ;
            if (s)
                for (u = a - 1; u >= 0; --u)
        ...
        draw() {
            ...
            let c;
            for (n.dataset && n.dataset.draw(e, s, r, l),
            c = r; c < r + l; ++c) {
                const t = o[c];
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < n._cachedMeta.data.length) {
                ...
                s = n.$context || (n.$context = function(t, e) {
                    return Object.assign(Object.create(t), {
                        active: !1,
                        dataset: void 0,
                        datasetIndex: e,
        ...
        _resolveAnimations(t, e, i) {
            ...
            return l && l._cacheable && (s[a] = Object.freeze(c)),
            c
        }
        getSharedOptions(t) {
            if (t.$shared)
    ...
    function Ii(t, e) {
        ...
        if (s > 0) {
            ...
            for (Fi(e, l, c, $(n) ? 0 : a - n, a),
            t = 0,
            i = s - 1; t < i; t++)
                Fi(e, l, c, o[t], o[t + 1]);
            return Fi(e, l, c, r, $(n) ? e.length : r + n),
            l
        }
        return Fi(e, l, c),
        l
    ...
    function Bi(t, e, i) {
        ...
        if (!(i && (l = 1 === n ? Math.max(c - s, a - c) : 0 === e ? (t.getPixelForTick(1) - c) / 2 : (c - t.getPixelForTick(o - 1)) / 2,
        c += o < e ? l : -l,
        c < s - r || c > a + r)))
            return c
    }
    ...
    function Ni(t, e, i) {
        let o = n(t);
        return (i && "right" !== e || !i && "right" === e) && (o = (t=>"left" === t ? "right" : "right" === t ? "left" : t)(o)),
        o
    }
    class ji extends Oi {
        constructor(t) {
        ...
        update(t, e, i) {
            ...
            n._maxLength = n.isHorizontal() ? n.width + i.left + i.right : n.height + i.top + i.bottom,
            n._dataLimitsCached || (n.beforeDataLimits(),
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = Ii(n, n.ticks),
            n._labelSizes = null),
        ...
        _callHooks(t) {
            const e = this;
            e.chart.notifyPlugins(t, e.getContext()),
            Q(e.options[t], [e])
        }
        beforeDataLimits() {
        ...
        generateTickLabels(t) {
            ...
            o = t.length; n < o; n++)
                s = t[n],
                s.label = Q(i.callback, [s.value, n, t], e)
        }
        ...
        calculateLabelRotation() {
            ...
            d + 6 > a && (a = f / (n - (e.offset ? .5 : 1)),
            r = t.maxHeight - Wi(e.grid) - i.padding - Hi(e.title, t.chart.options.font),
            l = Math.sqrt(d * d + u * u),
            c = Et(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l))),
        ...
        fit() {
            ...
            if (a) {
                ...
                if (r ? (e.width = t.maxWidth,
                e.height = Wi(s) + a) : (e.height = t.maxHeight,
                e.width = Wi(s) + a),
            ...
            t._handleMargins(),
            r ? (t.width = t._length = i.width - t._margins.left - t._margins.right,
            t.height = e.height) : (t.width = e.width,
            t.height = t._length = i.height - t._margins.top - t._margins.bottom)
        }
        _calculatePadding(t, e, i, n) {
            ...
            if (o.isHorizontal()) {
                ...
                let d = 0
                  , u = 0;
                l ? c ? (d = n * t.width,
                u = i * e.height) : (d = i * t.height,
                u = n * e.width) : "start" === s ? u = e.width : "end" === s ? d = t.width : (d = t.width / 2,
                u = e.width / 2),
        ...
        _handleMargins() {
            const t = this;
            t._margins && (t._margins.left = Math.max(t.paddingLeft, t._margins.left),
            ...
            for (a = 0; a < e; ++a) {
                ...
                $(c) || Y(c)) {
                    if (Y(c))
                        ...
                        l = c.length; r < l; ++r)
                            m = c[r],
                            $(m) || Y(m) || (g = $t(i, u.data, u.gc, g, m),
                            p += f)
                } else
                    g = $t(i, u.data, u.gc, g, c),
                    p = f;
                o.push(g),
                s.push(p),
                x = Math.max(g, x),
        ...
        getContext(t) {
            ...
            return e.$context || (e.$context = (n = e.chart.getContext(),
            o = e,
        ...
        _computeLabelItems(t) {
            ...
            m = r.length; p < m; ++p) {
                ...
                const i = S / 2
                  ...
                  , h = t.textStrokeWidth;
                a ? (_ = M,
                P = "top" === o ? "near" === c || 0 !== f ? -S * k + k / 2 : "center" === c ? -C.highest.height / 2 - i * k + k : -C.highest.height + k / 2 : "near" === c || 0 !== f ? k / 2 : "center" === c ? C.highest.height / 2 - i * k : C.highest.height - S * k) : (y = M,
                P = (1 - S) * k / 2),
                g.push({
                    rotation: f,
                    label: b,
        ...
        _getYAxisLabelAlignment(t) {
            ...
            let l, c;
            return "left" === i ? o ? (l = "left",
            c = e.right - s) : (c = e.right - a,
            "near" === n ? l = "right" : "center" === n ? (l = "center",
            c -= r / 2) : (l = "left",
            c = e.left)) : "right" === i ? o ? (l = "right",
            c = e.left + s) : (c = e.left + a,
            "near" === n ? l = "left" : "center" === n ? (l = "center",
            c += r / 2) : (l = "right",
            c = e.right)) : l = "right",
            {
                textAlign: l,
        ...
        drawGrid(t) {
            ...
            if (a) {
                const t = i.setContext(e.getContext(e._ticksLength - 1))
                  ...
                  , s = e._borderValue;
                let r, l, c, d;
                e.isHorizontal() ? (r = Ut(o, e.left, a) - a / 2,
                l = Ut(o, e.right, n) + n / 2,
                c = d = s) : (c = Ut(o, e.top, a) - a / 2,
        ...
        return new Proxy(o,{
            ...
            get: (t,e,i)=>Ki(t, e, (()=>function(t, e, i) {
                ...
                dt(r) && a.isScriptable(e) && (r = function(t, e, i, n) {
                    ...
                    if (r.has(t))
                        throw new Error("Recursion detected: " + [...r].join("->") + "->" + t);
                    r.add(t),
                    e = e(s, a || n),
                    r.delete(t),
    ...
    function Ji(t, e, i, n) {
        const o = e._rootScopes
          ...
          , r = new Set
          , l = t[0];
        U(l) && !(i in l) && r.add(l[i] = {}),
        r.add(n);
        let c = tn(r, a, i, s || i);
        return null !== c && ((!ht(s) || s === i || (c = tn(r, a, s, c),
        null !== c)) && $i([...r], [""], o, s))
    }
    function tn(t, e, i, n) {
        for (; i; )
    ...
    function rn(t) {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = sn(t, h + 1),
                l && c && (Ot(e[h], 0, on) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h],
                s = i[h + 1] / e[h],
    ...
    function cn(t, e, i, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            n = t.length; i < n; ++i)
                ...
                r = i < n - 1 && Kt(t[i + 1], e),
                s && (o = t[i],
                a && (o.cp1x = ln(o.cp1x, e.left, e.right),
                o.cp1y = ln(o.cp1y, e.top, e.bottom)),
                r && (o.cp2x = ln(o.cp2x, e.left, e.right),
    ...
    function bn(t, e, i) {
        ...
        const {property: n, start: o, end: s} = i
          ...
          , {start: h, end: d, loop: u} = function(t, e, i) {
            const {property: n, start: o, end: s} = i
        ...
        for (let t = h, i = h; t <= d; ++t)
            ...
            null !== b && y() && (f.push(xn(b, t, u, a)),
            b = null),
            i = t,
            m = g);
        return null !== b && f.push(xn(b, d, u, a)),
        f
    }
    function _n(t, e) {
        const i = []
    ...
    class Mn {
        ...
        unregister(t) {
            const e = this.items
              ...
              , n = this.scope;
            i in e && delete e[i],
            n && i in mt[n] && (delete mt[n][i],
            this.override && delete ut[i])
        }
    }
    var wn = new class {
        constructor() {
    ...
    class kn {
        ...
        notify(t, e, i) {
            const n = this;
            "beforeInit" === e && (n._init = n._createDescriptors(t, !0),
            n._notify(n._init, t, "install"));
            const o = n._descriptors(t)
              , s = n._notify(o, t, e, i);
            return "destroy" === e && (n._notify(o, t, "stop"),
            n._notify(n._init, t, "uninstall")),
            s
        }
        _notify(t, e, i, n) {
            n = n || {};
            for (const o of t) {
                const t = o.plugin;
                if (!1 === Q(t[i], [e, n, o.options], t) && n.cancelable)
                    return !1
            }
            return !0
        }
    ...
    class En {
        ...
        datasetAnimationScopeKeys(t, e) {
            return Ln(`${t}.transition.${e}`, (()=>[[`datasets.${t}.transitions.${e}`, "transitions." + e], ["datasets." + t, ""]]))
        }
        datasetElementScopeKeys(t, e) {
            return Ln(`${t}-${e}`, (()=>[[`datasets.${t}.elements.${e}`, "datasets." + t, "elements." + e, ""]]))
        }
        pluginScopeKeys(t) {
            const e = t.id;
    ...
    function Nn(t) {
        return Hn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
    ...
    class Yn {
        constructor(t, e) {
            ...
            const o = Nn(t)
              , s = $n(o);
            if (s)
                throw new Error("Canvas is already in use. Chart with ID '" + s.id + "' must be destroyed before the canvas can be reused.");
            ...
            jn[n.id] = n,
            l && c ? (a.listen(n, "complete", Bn),
            a.listen(n, "progress", Wn),
            n._initialize(),
            n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item")
        }
        get aspectRatio() {
        ...
        _initialize() {
            const t = this;
            return t.notifyPlugins("beforeInit"),
        ...
        clear() {
            return Xt(this.canvas, this.ctx),
            this
        }
        stop() {
            return a.stop(this),
        ...
        _resize(t, e) {
            ...
            i.width === a.width && i.height === a.height && r === l || (i.width = a.width,
            i.height = a.height,
            i._aspectRatio = i.aspectRatio,
            be(i, l, !0),
            i.notifyPlugins("resize", {
                size: a
            }),
            Q(n.onResize, [i, a], i),
        ...
        buildOrUpdateScales() {
            const t = this
              ...
              , i = e.scales
              , n = t.scales
              , o = Object.keys(n).reduce(((t,e)=>(t[e] = !1,
            t)), {});
            let s = [];
            ...
            J(s, (i=>{
                const s = i.options
                  ...
                  , r = Cn(a, s)
                  , l = K(s.type, i.dtype);
                void 0 !== s.position && zn(s.position, r) === zn(i.dposition) || (s.position = i.dposition),
                o[a] = !0;
                let c = null;
                if (a in n && n[a].type === l)
                    c = n[a];
                else {
                    c = new (wn.getScale(l))({
                        id: a,
        ...
        buildOrUpdateControllers() {
            const t = this
              ...
              , i = t.data.datasets;
            let n, o;
            for (t._removeUnreferencedMetasets(),
            n = 0,
            o = i.length; n < o; n++) {
                const o = i[n];
                let s = t.getDatasetMeta(n);
                const a = o.type || t.config.type;
                if (s.type && s.type !== a && (t._destroyDatasetMeta(n),
                s = t.getDatasetMeta(n)),
                s.type = a,
        ...
        update(t) {
            ...
            if (e.ensureScalesHaveIDs(),
            e.buildOrUpdateScales(),
            e._plugins.invalidate(),
            !1 === e.notifyPlugins("beforeUpdate", {
                mode: t,
                cancelable: !0
            }))
                return;
            ...
            for (let t = 0, i = e.data.datasets.length; t < i; t++) {
                const {controller: i} = e.getDatasetMeta(t)
                  , a = !n && -1 === o.indexOf(i);
                i.buildOrUpdateElements(a),
                s = Math.max(+i.getMaxOverflow(), s)
            }
            e._minPadding = s,
            e._updateLayout(s),
            n || J(o, (t=>{
        ...
        _updateLayout(t) {
            ...
            e._layers = [],
            J(e.boxes, (t=>{
                n && "chartArea" === t.position || (t.configure && t.configure(),
        ...
        _updateDataset(t, e) {
            ...
            !1 !== i.notifyPlugins("beforeDatasetUpdate", o) && (n.controller._update(e),
            o.cancelable = !1,
        ...
        render() {
            ...
            !1 !== t.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(),
            Bn({
                chart: t
            })))
        }
        ...
        bindEvents() {
            const t = this
              ...
              , o = (n,o)=>{
                e[n] && (i.removeEventListener(t, n, o),
                delete e[n])
            }
            ;
        ...
        updateHoverStyle(t, e, i) {
            ...
            let o, s, a, r;
            for ("dataset" === e && (o = this.getDatasetMeta(t[0].datasetIndex),
        ...
        _eventHandler(t, e) {
            ...
            if (!1 === i.notifyPlugins("beforeEvent", n))
                return;
        ...
        _handleEvent(t, e) {
            ...
            let r = []
              , l = !1
              , c = null;
            return "mouseout" !== t.type && (r = i.getElementsAtEventForMode(t, s.mode, s, a),
            c = "click" === t.type ? i._lastEvent : t),
            i._lastEvent = null,
            Q(o.onHover, [t, r, i], i),
            "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Kt(t, i.chartArea, i._minPadding) && Q(o.onClick, [t, r, i], i),
            l = !tt(r, n),
            (l || e) && (i._active = r,
            i._updateHoverStyles(r, n, e)),
            i._lastEvent = c,
            l
        }
    }
    ...
    function Zn(t) {
        ...
        const r = ()=>{
            a = Math.min(a, i && Math.abs(o - s) || a),
            s = o
        }
        ;
        for (i = 0,
        n = e.length; i < n; ++i)
            o = t.getPixelForValue(e[i]),
            r();
        for (i = 0,
    ...
    class eo extends Ai {
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            const o = i._custom;
            o && e === this._cachedMeta.vScale && (t.min = Math.min(t.min, o.min),
        ...
        _getStacks(t, e) {
            ...
            for (r = 0; r < s; ++r) {
                ...
                if ((!1 === o || -1 === a.indexOf(l.stack) || void 0 === o && void 0 === l.stack) && a.push(l.stack),
                l.index === t)
                    break
            }
        ...
        _calculateBarValuePixels(t) {
            ...
            h = c - p,
            void 0 !== s && Math.abs(h) < s && (h = h < 0 ? -s : s,
            0 === d && (p -= h / 2),
            c = p + h);
            const m = o || 0;
            ...
            if (e.grouped) {
                const n = o.skipNull ? i._getStackCount(t) : e.stackCount
                  , l = "flex" === o.barThickness ? function(t, e, i, n) {
                    ...
                    let s, a;
                    return $(o) ? (s = e.min * i.categoryPercentage,
                    a = i.barPercentage) : (s = o * n,
                    a = 1),
                    {
                        chunk: s / n,
                        ratio: a,
    ...
    class io extends Ai {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let l = e; l < e + i; l++) {
                ...
                h && (u.options = o.resolveDataElementOptions(l, n),
    ...
    class no extends Ai {
        ...
        getMaxBorderWidth(t) {
            ...
            if (!t)
                for (o = 0,
                s = n.data.datasets.length; o < s; ++o)
            ...
            s = t.length; o < s; ++o)
                ...
                "inner" !== l.borderAlign && (i = Math.max(i, l.borderWidth || 0, l.hoverBorderWidth || 0));
            return i
        }
        getMaxOffset(t) {
            let e = 0;
        ...
        update(t) {
            ...
            let {start: r, count: l} = function(t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (o = Ht(Math.min(ie(r, a.axis, c).lo, i ? n : ie(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
                    s = u ? Ht(Math.max(ie(r, a.axis, h).hi + 1, i ? 0 : ie(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
                }
                return {
                    start: o,
                    count: s
    ...
    class so extends Ai {
        ...
        _updateRadius() {
            ...
            t.outerRadius = s - a * t.index,
            t.innerRadius = t.outerRadius - a
        }
        updateElements(t, e, i, n) {
            const o = this
              , s = "reset" === n
            ...
            for (f = e; f < e + i; f++) {
                ...
                g = m,
                s && (l.animateScale && (x = 0),
                l.animateRotate && (i = m = u));
                const b = {
                    x: h,
                    y: d,
                    innerRadius: 0,
    ...
    function ho(t, e) {
        ...
        t.arc(s, a, r, i - c, n + c),
        l > o ? (c = o / l,
        t.arc(s, a, l, n + c, i - c, !0)) : t.arc(s, a, o, n + Mt, i - Mt),
        t.closePath(),
        t.clip()
    }
    function uo(t, e) {
    ...
    function fo(t, e) {
        const {x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a, options: r} = e
          , l = e.outerRadius
          , c = e.innerRadius + a
          , h = "inner" === r.borderAlign;
        r.borderWidth && (h ? (t.lineWidth = 2 * r.borderWidth,
        t.lineJoin = "round") : (t.lineWidth = r.borderWidth,
        t.lineJoin = "bevel"),
        e.fullCircles && function(t, e, i) {
            const {x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r} = e
              ...
              , c = e.innerRadius + r;
            let h;
            for (i && (e.endAngle = e.startAngle + bt,
            ho(t, e),
            e.endAngle = a,
            e.endAngle === e.startAngle && (e.endAngle += bt,
            e.fullCircles--)),
            t.beginPath(),
            t.arc(n, o, c, s + bt, s, !0),
            h = 0; h < e.fullCircles; ++h)
                t.stroke();
            for (t.beginPath(),
            t.arc(n, o, l, s, s + bt),
            h = 0; h < e.fullCircles; ++h)
            ...
            !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0)) {
                ...
                function(t, e) {
                    if (e.fullCircles) {
                        ...
                        uo(t, e);
                        for (let i = 0; i < e.fullCircles; ++i)
                            t.fill()
                    }
                    isNaN(e.circumference) || (e.endAngle = e.startAngle + e.circumference % bt),
                    uo(t, e),
                    t.fill()
                }(t, e),
                fo(t, e),
    ...
    function xo(t, e, i, n) {
        ...
        for (d = 0; d <= c; ++d)
            ...
            g = !1) : h(t, f, u, p, s.stepped),
            f = u);
        return l && (u = o[(r + (p ? c : 0)) % a],
        h(t, f, u, p, s.stepped)),
        !!l
    }
    function bo(t, e, i, n) {
    ...
    const yo = "function" == typeof Path2D ? function(t, e, i, n) {
        let o = e._path;
        o || (o = e._path = new Path2D,
        e.path(o, i, n) && o.closePath()),
        t.stroke(o)
    }
    : function(t, e, i, n) {
        t.beginPath(),
        e.path(t, i, n) && t.closePath(),
        t.stroke()
    }
    ;
    class vo extends Oi {
        ...
        draw(t, e, i, n) {
            const o = this
              , s = o.options || {};
            (o.points || []).length && s.borderWidth && (t.save(),
            function(t, e) {
    ...
    class wo extends Oi {
        ...
        draw(t) {
            const e = this
              , i = e.options;
            e.skip || i.radius < .1 || (t.strokeStyle = i.borderColor,
    ...
    function So(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Po(e, "left", "right", t.base > t.x) : Po(e, "bottom", "top", t.base < t.y),
        i[e] = !0,
        i) : i
    }
    function Po(t, e, i, n) {
        var o, s, a;
        return n ? (a = i,
        t = Do(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = Do(t, e, i),
        t
    }
    function Do(t, e, i) {
    ...
    function To(t, e) {
        ...
        t.arc(i + o - a.bottomRight, n + s - a.bottomRight, a.bottomRight, Mt, 0, !0),
                ...
                case "lttb":
                    h = function(t, e, i) {
                        ...
                        a = 0; a < n - 2; a++) {
                            ...
                            for (l = c = -1,
                            e = m; e < x; e++)
                                c = .5 * Math.abs((b - i) * (t[e].y - _) - (b - t[e].x) * (n - _)),
                                c > l && (l = c,
                                r = t[e],
                                h = e);
                            o[d++] = r,
                        ...
                        return o[d++] = t[t.length - 1],
                        o
                    }(l, n, i);
                    break;
                case "min-max":
                    h = function(t, e) {
                        let i, n, o, s, a, r, l, c, h, d, u = 0, f = 0;
                        const g = []
                          , p = t[0].x
                          , m = t[t.length - 1].x - p;
    ...
    function zo(t, e, i) {
        const n = function(t) {
            ...
            return void 0 === n && (n = !!e.backgroundColor),
            !1 !== n && null !== n && (!0 === n ? "origin" : n)
        }(t);
        if (U(n))
            return !isNaN(n.value) && n;
        let o = parseFloat(n);
        return X(o) && Math.floor(o) === o ? ("-" !== n[0] && "+" !== n[0] || (o = e + o),
        !(o === e || o < 0 || o >= i) && o) : ["origin", "start", "end", "stack"].indexOf(n) >= 0 && n
    }
    class Vo {
        constructor(t) {
            this.x = t.x,
    ...
    function Bo(t) {
        return (t.scale || {}).getPointPositionForValue ? function(t) {
            ...
            let l, c, h;
            if (h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(),
            n.grid.circular)
                return c = e.getPointPositionForValue(0, a),
                new Vo({
                    x: c.x,
                    y: c.y,
            ...
            const {scale: e={}, fill: i} = t;
            let n, o = null;
            return "start" === i ? o = e.bottom : "end" === i ? o = e.top : U(i) ? o = e.getPixelForValue(i.value) : e.getBasePixel && (o = e.getBasePixel()),
            X(o) ? (n = e.isHorizontal(),
            {
                x: n ? o : null,
                y: n ? null : o
            }) : null
                ...
                for (let t = 0; t < c.length; ++t) {
                    ...
                    for (let t = 0; t < h.length; t++)
                        a.push({
                            ...
                            target: e,
                            start: {
                                [i]: qo(l, n, "start", Math.max)
                            },
                            end: {
                                [i]: qo(l, n, "end", Math.min)
                            }
                        })
                }
            }
    ...
    var Qo = {
        ...
        beforeDatasetsDraw(t) {
            ...
            for (n = e.length - 1; n >= 0; --n)
                o = e[n].$filler,
                o && o.line.updateControlPoints(i)
        },
    ...
    class ts extends Oi {
        ...
        fit() {
            const t = this
              , {options: e, ctx: i} = t;
            if (!e.display)
                return void (t.width = t.height = 0);
            const n = e.labels
              , o = Ee(n.font)
              , s = o.size
            ...
            let c, h;
            i.font = o.string,
            t.isHorizontal() ? (c = t.maxWidth,
            h = t._fitRows(a, s, r, l) + 10) : (h = t.maxHeight,
            c = t._fitCols(a, s, r, l) + 10),
        ...
        _fitRows(t, e, i, n) {
            ...
            return o.legendItems.forEach(((t,o)=>{
                ...
                (0 === o || c[c.length - 1] + g + 2 * r > a) && (d += h,
                c[c.length - (o > 0 ? 0 : 1)] = 0,
                f += h,
                u++),
                l[o] = {
                    left: 0,
        ...
        adjustHitBoxes() {
            ...
            const e = t._computeTitleHeight()
              , {legendHitBoxes: i, options: {align: n, labels: {padding: s}}} = t;
        ...
        _draw() {
            ...
            t.legendItems.forEach(((e,u)=>{
                ...
                let P = m.x
                  , D = m.y;
                h.setWidth(t.width),
                y ? u > 0 && P + S + f > t.right && (D = m.y += M,
                m.line++,
                P = m.x = o(r, t.left + f, t.right - n[m.line])) : u > 0 && D + M > t.bottom && (P = m.x = P + i[m.line].width + f,
                m.line++,
                ...
                !function(t, e, i) {
                    ...
                    if (a.fillStyle = K(i.fillStyle, c),
        ...
        handleEvent(t) {
            ...
            if ("mousemove" === t.type) {
                const a = e._hoveredItem
                  , r = (s = n,
                null !== (o = a) && null !== s && o.datasetIndex === s.datasetIndex && o.index === s.index);
                a && !r && Q(i.onLeave, [t, a, e], e),
                e._hoveredItem = n,
                n && !r && Q(i.onHover, [t, n, e], e)
            } else
                n && Q(i.onClick, [t, n, e], e);
            var o, s
        }
    }
    var es = {
            ...
            labels: {
                ...
                generateLabels(t) {
                    const e = t.data.datasets
                      , {labels: {usePointStyle: i, pointStyle: n, textAlign: o}} = t.legend.options;
    ...
    class is extends Oi {
        ...
        _drawArgs(t) {
            const {top: e, left: i, bottom: n, right: s, options: a} = this
              , r = a.align;
            let l, c, h, d = 0;
            return this.isHorizontal() ? (c = o(r, i, s),
            h = e + t,
            l = s - i) : ("left" === a.position ? (c = i + t,
            h = o(r, n, e),
            d = -.5 * xt) : (c = s - t,
            h = o(r, e, n),
            d = .5 * xt),
    ...
    function ls(t, e) {
        ...
        d && (p += d * c.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom),
        x) {
    ...
    function ds(t, e, i, n) {
        ...
        const u = function(t, e, i) {
            let {y: n, height: o} = t;
            return "top" === e ? n += i : n -= "bottom" === e ? o + i : o / 2,
            n
        }(e, l, c);
    ...
    class ps extends Oi {
        ...
        _resolveAnimations() {
            ...
            const i = t._chart
              ...
              , s = new bi(t._chart,o);
            return o._cacheable && (t._cachedAnimations = Object.freeze(s)),
            s
        }
        getContext() {
            const t = this;
            return t.$context || (t.$context = (e = t._chart.getContext(),
            i = t,
            n = t._tooltipItems,
        ...
        _createItems(t) {
            ...
            for (r = 0,
            l = i.length; r < l; ++r)
                c.push(rs(e._chart, i[r]));
            return t.filter && (c = c.filter(((e,i,o)=>t.filter(e, i, o, n)))),
        ...
        update(t, e) {
            ...
            t && n.external && n.external.call(i, {
                chart: i._chart,
                tooltip: i,
                replay: e
            })
        ...
        getCaretPosition(t, e, i) {
            ...
            g = p - a,
            m = p + a),
            f = d) : (u = "left" === n ? r + s + a : "right" === n ? r + c - s - a : this.caretX,
            "top" === o ? (g = l,
            p = g - a,
            d = u - a,
            f = u + a) : (g = l + h,
        ...
        _drawColorBox(t, e, i, n, o) {
            ...
            if (o.usePointStyle) {
                ...
                t.fillStyle = o.multiKeyBackground,
                t.fillRect(n.leftForLtr(u, c), g, c, l),
                t.lineWidth = 1,
                t.strokeStyle = a.borderColor,
                t.strokeRect(n.leftForLtr(u, c), g, c, l),
                t.fillStyle = a.backgroundColor,
                t.fillRect(n.leftForLtr(n.xPlus(u, 1), c - 2), g + 1, c - 2, l - 2);
        ...
        drawBody(t, e, i) {
            ...
            v = o.length; _ < v; ++_) {
                ...
                J(m.before, g),
                b = m.lines,
                r && b.length && (n._drawColorBox(e, t, _, f, i),
        ...
        _updateAnimationTarget(t) {
            ...
            if (o || s) {
                ...
                const a = e._size = ls(e, t)
                  ...
                  , l = hs(i, t, r)
                  , c = ds(t, r, l, i);
                o._to === c.x && s._to === c.y || (e.xAlign = l.xAlign,
                e.yAlign = l.yAlign,
                e.width = a.width,
                e.height = a.height,
                e.caretX = n.x,
        ...
        handleEvent(t, e) {
            ...
            let s = !1
              , a = [];
            "mouseout" !== t.type && (a = i._chart.getElementsAtEventForMode(t, n.mode, n, e),
            n.reverse && a.reverse());
            const r = i._positionChanged(a, t);
            return s = e || !tt(a, o) || r,
            s && (i._active = a,
            (n.enabled || n.external) && (i._eventPosition = {
                x: t.x,
                y: t.y
            },
            i.update(!0, e))),
    ...
    function bs(t, e, i) {
        const n = t.indexOf(e);
        if (-1 === n)
            return ((t,e,i)=>"string" == typeof e ? t.push(e) - 1 : isNaN(e) ? null : i)(t, e, i);
    ...
    class _s extends ji {
        ...
        parse(t, e) {
            ...
            return ((t,e)=>null === t ? null : Ht(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : bs(i, t, K(e, t)), i.length - 1)
        }
        determineDataLimits() {
            const t = this
              , {minDefined: e, maxDefined: i} = t.getUserBounds();
            let {min: n, max: o} = t.getMinMax(!0);
            "ticks" === t.options.bounds && (e || (n = 0),
            i || (o = t.getLabels().length - 1)),
            t.min = n,
            t.max = o
        }
        buildTicks() {
        ...
        getPixelForValue(t) {
            const e = this;
            return "number" != typeof t && (t = e.parse(t)),
    ...
    class ys extends ji {
        ...
        getTickLimit() {
            ...
            return o ? i = Math.ceil(t.max / o) - Math.floor(t.min / o) + 1 : (i = t.computeTickLimit(),
            n = n || 11),
            n && (i = Math.min(n, i)),
            i
        }
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                x = Math.floor(d / y) * y,
                b = Math.ceil(u / y) * y,
                f && g && n && Tt((s - o) / n, y / 1e3) ? (_ = Math.min((s - o) / y, l),
                y = (s - o) / _,
                x = o,
                b = s) : p ? (x = f ? o : x,
                b = g ? s : b,
                _ = r - 1,
                y = (b - x) / _) : (_ = (b - x) / y,
                _ = Ot(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_)),
                ...
                x <= o && v++,
                Ot(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v)
                    i.push({
                        value: Math.round((x + v * y) * m) / m
                    });
                return g ? Ot(i[i.length - 1].value, s, y / 10) ? i[i.length - 1].value = s : i.push({
                    value: s
                }) : i.push({
                    value: b
                }),
            ...
            return "ticks" === e.bounds && Lt(o, t, "value"),
            e.reverse ? (o.reverse(),
            t.start = t.max,
    ...
    class ws extends ji {
        ...
        buildTicks() {
            ...
            return "ticks" === e.bounds && Lt(i, t, "value"),
            e.reverse ? (i.reverse(),
            t.start = t.max,
            t.end = t.min) : (t.start = t.min,
            t.end = t.max),
        ...
        getPixelForValue(t) {
            const e = this;
            return void 0 !== t && 0 !== t || (t = e.min),
            null === t || isNaN(t) ? NaN : e.getPixelForDecimal(t === e.min ? 0 : (St(t) - e._startValue) / e._valueRange)
        }
        getValueForPixel(t) {
            const e = this
    ...
    function Cs(t, e, i, n) {
        const {ctx: o} = t;
        if (i)
            o.arc(t.xCenter, t.yCenter, e, 0, bt);
        else {
    ...
    class Os extends ys {
        ...
        fit() {
            ...
            e.display && e.pointLabels.display ? function(t) {
                ...
                for (n = 0; n < l; n++) {
                    ...
                    p.start < e.l && (e.l = p.start,
                    i.l = f),
                    p.end > e.r && (e.r = p.end,
                    i.r = f),
                    m.start < e.t && (e.t = m.start,
                    i.t = f),
                    m.end > e.b && (e.b = m.end,
                    i.b = f)
                }
        ...
        _setReductions(t, e, i) {
            ...
            a = As(a),
            r = As(r),
            n.drawingArea = Math.max(t / 2, Math.min(Math.floor(t - (o + s) / 2), Math.floor(t - (a + r) / 2))),
        ...
        drawBackground() {
            ...
            if (e) {
                ...
                n.save(),
                n.beginPath(),
                Cs(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
                n.closePath(),
                n.fillStyle = e,
                n.fill(),
                n.restore()
            ...
            if (i.pointLabels.display && function(t, e) {
                ...
                for (let o = e - 1; o >= 0; o--) {
                    ...
                    if (!$(f)) {
                        const t = Re(e.backdropPadding);
                        i.fillStyle = f,
                        i.fillRect(c - t.left, h - t.top, d - c + t.width, u - h + t.height)
                    }
        ...
        drawLabels() {
            ...
            t.ticks.forEach(((o,r)=>{
                ...
                const l = n.setContext(t.getContext(r))
                  , c = Ee(l.font);
                if (s = t.getDistanceFromCenterForValue(t.ticks[r].value),
                l.showLabelBackdrop) {
    ...
    function Es(t, e) {
        ...
        let r = e;
        return "function" == typeof o && (r = o(r)),
        X(r) || (r = "string" == typeof o ? i.parse(r, o) : i.parse(r)),
        null === r ? null : (s && (r = "week" !== s || !At(a) && !0 !== a ? i.startOf(r, s) : i.startOf(r, "isoWeek", a)),
        +r)
    }
    function Is(t, e, i, n) {
        const o = Ls.length;
        for (let s = Ls.indexOf(t); s < o - 1; ++s) {
            ...
            if (t.common && Math.ceil((i - e) / (o * t.size)) <= n)
                return Ls[s]
        }
        return Ls[o - 1]
    }
    ...
    class Vs extends ji {
        ...
        buildTicks() {
            ...
            "ticks" === e.bounds && o.length && (t.min = t._userMin || o[0],
            t.max = t._userMax || o[o.length - 1]);
            const s = t.min
              , a = oe(o, s, t.max);
            return t._unit = i.unit || (n.autoSkip ? Is(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) {
            ...
            t._majorUnit = n.major.enabled && "year" !== t._unit ? function(t) {
        ...
        initOffsets(t) {
            const e = this;
            let i, n, o = 0, s = 0;
            e.options.offset && t.length && (i = e.getDecimalForValue(t[0]),
            o = 1 === t.length ? 1 - i : (e.getDecimalForValue(t[1]) - i) / 2,
            n = e.getDecimalForValue(t[t.length - 1]),
            s = 1 === t.length ? n : (n - e.getDecimalForValue(t[t.length - 2])) / 2);
        ...
        _generate() {
            const t = this
              ...
              , h = {};
            let d, u, f = i;
            if (c && (f = +e.startOf(f, "isoWeek", l)),
            f = +e.startOf(f, c ? "day" : a),
            e.diff(n, i, a) > 1e5 * r)
                throw new Error(i + " and " + n + " are too far apart with stepSize of " + r + " " + a);
            const g = "data" === o.ticks.source && t.getDataTimestamps();
            for (d = f,
            u = 0; d < n; d = +e.add(d, r, a),
            u++)
                Fs(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Fs(h, d, g),
    ...
    class Ws extends Vs {
        ...
        _getTimestampsForTable() {
            ...
            return e = i.length && n.length ? t.normalize(i.concat(n)) : i.length ? i : n,
            e = t._cache.all = e,
            e
        }
        getPixelForValue(t, e) {
    ...
    return Yn.register(co, Hs, Eo, xs),
    Yn.helpers = {
        ...vn
    },
    Yn._adapters = Gn,
